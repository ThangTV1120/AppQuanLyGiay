...
import com.example.appquanlygiay.Activity.activity_list_sanpham_nhap;
import com.example.appquanlygiay.Models.ChiTietHoaDonNhap;
import com.example.appquanlygiay.R;

import java.util.List;

public class List_SanPham_Nhap_Adapter extends BaseAdapter {

     private activity_list_sanpham_nhap context;
    private int layout;
    private List<ChiTietHoaDonNhap> ChiTietHoaDonNhapSP;
    public List_SanPham_Nhap_Adapter(activity_list_sanpham_nhap context, int layout, List<ChiTietHoaDonNhap> chiTietHoaDonNhap){
